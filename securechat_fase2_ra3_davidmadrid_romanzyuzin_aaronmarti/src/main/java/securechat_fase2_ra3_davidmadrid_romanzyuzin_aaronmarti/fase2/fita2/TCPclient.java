package securechat_fase2_ra3_davidmadrid_romanzyuzin_aaronmarti.fase2.fita2;
...
public class TCPclient {
    ...
    public static void main(String[] args) {
        ...
        try (Socket socket = new Socket(host, port); 
            ...
            System.out.println(ANSI_CYAN + "Missatge enviat: " + ANSI_RESET + missatgeEnviament + ANSI_RESET);
