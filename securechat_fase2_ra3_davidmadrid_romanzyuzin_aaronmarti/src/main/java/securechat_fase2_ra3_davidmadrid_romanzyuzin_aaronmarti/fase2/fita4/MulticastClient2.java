package securechat_fase2_ra3_davidmadrid_romanzyuzin_aaronmarti.fase2.fita4;
...
public class MulticastClient2 {
  ...
  public static void main(String[] args) {
    ...
    try (MulticastSocket socket = new MulticastSocket(port)) { // 1. Escuchar en este puerto
